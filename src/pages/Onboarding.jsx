      ...
      <AnimatePresence mode="wait">
        ...
        {step === 5 && (
          <motion.div key="s6" variants={variants} initial="enter" animate="center" exit="exit" transition={{ duration: 0.3 }}
            ...
            {/* Coach's take — personalized read on their game, shown right
                before the paywall as the value hook (replaces the old 3-drill
                preview). Generated by generateInitialPlan into plan_data. */}
            {readyPlan?.plan_data?.coachs_take && (
              <div className="cut-glass p-5 w-full text-left">
                <p className="cut-eyebrow text-cut-gold mb-2">Your coach's take</p>
                <p className="text-cut-ink text-[15px] leading-relaxed">
                  {readyPlan.plan_data.coachs_take}
                </p>
              </div>
            )}

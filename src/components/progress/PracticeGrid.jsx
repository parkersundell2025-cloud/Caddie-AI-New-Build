...
export default function PracticeGrid({ sessions }) {
  ...
  return (
    <div style={CARD} className="p-5 space-y-5">
      <p className="text-[10px] font-bold uppercase tracking-[0.15em]" style={{ color: 'rgba(255,255,255,0.4)' }}>Practice Consistency · Last 30 Days</p>
        ...
        {days.map(day => (
          <div
            ...
            style={{
              width: 12,
              height: 12,
              background: sessionDates.has(day) ? '#a8d5a2' : 'rgba(255,255,255,0.1)',
              boxShadow: sessionDates.has(day) ? '0 0 6px rgba(168,213,162,0.4)' : 'none',
            }}
          />
        ))}
      </div>
      ...
      <div className="grid grid-cols-3 gap-0">
        <div className="text-center">
          ...
          <p className="text-[10px] uppercase tracking-widest mt-1" style={{ color: 'rgba(255,255,255,0.4)' }}>Current Streak</p>
        </div>
        <div className="text-center" style={{ borderLeft: '1px solid rgba(255,255,255,0.08)', borderRight: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <p className="text-[10px] uppercase tracking-widest mt-1" style={{ color: 'rgba(255,255,255,0.4)' }}>Best This Month</p>
        </div>
        <div className="text-center">
          ...
          <p className="text-[10px] uppercase tracking-widest mt-1" style={{ color: 'rgba(255,255,255,0.4)' }}>Sessions</p>
        </div>
      </div>
    </div>
  );
